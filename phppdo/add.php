...
?>
<div class="container">
   <h3>Data Masjid/Musholla Yang sholat(buka) di Kota DURI,RIAU dan Sekitarnya</h3>
   <h1>Add post</h1>
   <div class="row">
      ...
      <form class="form-horizontal" action="add.php" method="POST">
         <fieldset>
            <div class="form-group">
               <label class="col-sm-2">Masjid/mushalla</label>
               <div class="col-sm-20">
            ...
            <div class="form-group">
               <label class="col-sm-4"> Dibuka&nbspSejak&nbspTanggal</label>
               <div class="col-sm-20">
