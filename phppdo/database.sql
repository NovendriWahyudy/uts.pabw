...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Apr 2020 pada 14.53
...
-- Database: `pdocrud`
--
CREATE DATABASE IF NOT EXISTS `pdocrud` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci;
USE `pdocrud`;
...
CREATE TABLE `post` (
  `no` int(200) NOT NULL,
  `provinsi` varchar(200) CHARACTER SET latin1 NOT NULL,
  `jumlahkasus` int(200) NOT NULL,
...
INSERT INTO `post` (`no`, `provinsi`, `jumlahkasus`, `meninggal`, `published_on`) VALUES
(11, 'Aceh', 5, 1, '2020-04-09'),
(12, 'Bali', 63, 2, '2020-04-09'),
(13, 'Banten', 218, 21, '2020-04-09');
...
('root', '[{\"db\":\"pdocrud\",\"table\":\"login\"},{\"db\":\"pdocrud\",\"table\":\"post\"},{\"db\":\"crud\",\"table\":\"user\"}]');
...
('root', 'pdocrud', 'login', '[]', '2020-04-27 07:58:25');
...
('root', '2020-04-27 12:52:19', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\",\"DefaultConnectionCollation\":\"latin1_swedish_ci\",\"ThemeDefault\":\"original\"}');
